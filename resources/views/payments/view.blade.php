...
@section('content')
    ...
    <div class="container">
      <div class="py-5 text-center">
        <img class="d-block mx-auto mb-4" src="{{ asset('images/hammer.png') }}" alt="" width="200" height="80">
        ...
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Serviço de Pintura</h6>
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Instalação eletrica</h6>
              </div>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="d-block my-3">
              ...
              <div class="custom-control custom-radio">
                <input id="paypal" name="paymentMethod" type="radio" class="custom-control-input" required>
                <label class="custom-control-label" for="paypal">Pessoalmente</label>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 mb-3">
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy;  2020 Hammer</p>
